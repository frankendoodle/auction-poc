...
public static class DbInitializer
{
    ...
    {
        if (await context.AuctionProperties.AnyAsync())
        {
            return;
        }

        var properties = new List<AuctionProperty>
        {
            new AuctionProperty
            {
                Title = "Former School",
                ...
                BiddingCloses = DateTime.UtcNow.AddDays(5),
            ...
            new AuctionProperty
            {
                ...
                BiddingCloses = DateTime.UtcNow.AddDays(3),
            ...
            new AuctionProperty
            {
                ...
                BiddingCloses = DateTime.UtcNow.AddDays(7),
            ...
            new AuctionProperty
            {
                ...
                BiddingCloses = DateTime.UtcNow.AddDays(4),
            ...
            new AuctionProperty
            {
                ...
                BiddingCloses = DateTime.UtcNow.AddDays(2),
            ...
            new AuctionProperty
            {
                ...
                BiddingCloses = DateTime.UtcNow.AddDays(6),
            ...
            new AuctionProperty
            {
                ...
                BiddingCloses = DateTime.UtcNow.AddDays(8),
        ...
        await context.AuctionProperties.AddRangeAsync(properties);

    ...
    private List<AuctionProperty> GenerateSampleProperties()
    {
        return new List<AuctionProperty>
        {
            new AuctionProperty
            {
                ...
                ImageUrl = "https://via.placeholder.com/400x300/4A5568/FFFFFF?text=School+Building",
                IsLive = true,
                HasVideo = true,
                Zoning = "Residential"
            },
            new AuctionProperty
            {
                ...
                ImageUrl = "https://via.placeholder.com/400x300/6B7280/FFFFFF?text=Retail+Building",
                IsLive = true,
                HasVideo = true,
                Zoning = "Commercial"
            },
            new AuctionProperty
            {
                ...
                ImageUrl = "https://via.placeholder.com/400x300/10B981/FFFFFF?text=Industrial+Land",
                IsLive = true,
                HasVideo = false,
            ...
            new AuctionProperty
            {
                ...
                ImageUrl = "https://via.placeholder.com/400x300/EF4444/FFFFFF?text=Hotel",
                IsLive = true,
                HasVideo = true,
                Zoning = "Commercial"
            },
            new AuctionProperty
            {
                ...
                ImageUrl = "https://via.placeholder.com/400x300/F59E0B/FFFFFF?text=Commercial+Land",
                IsLive = true,
                HasVideo = true,
            ...
            new AuctionProperty
            {
                ...
                ImageUrl = "https://via.placeholder.com/400x300/8B5CF6/FFFFFF?text=Medical+Building",
                IsLive = true,
                HasVideo = true,
                IsOpportunityZone = true,
                Zoning = "Commercial"
            ...
            new AuctionProperty
            {
                ...
                ImageUrl = "https://via.placeholder.com/400x300/EC4899/FFFFFF?text=Development+Land",
                IsLive = true,
                HasVideo = false,
                Zoning = "Residential"
            },
            new AuctionProperty
            {
                ...
                BiddingCloses = DateTime.Now.AddDays(5),
                ImageUrl = "https://via.placeholder.com/400x300/3B82F6/FFFFFF?text=Industrial+Property",
                IsLive = true,
                HasVideo = true,
                Zoning = "Industrial"
            }
